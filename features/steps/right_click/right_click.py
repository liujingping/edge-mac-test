    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                ...
                'locator_value': "//XCUIElementTypeMenuItem[@title='Back']",
                'need_snapshot': 0,
            },
        ),
    )
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.XPATH',
                'locator_value': "//XCUIElementTypeMenuItem[@title='Forward']",
                'need_snapshot': 0,
            },
        ),
    )
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.XPATH',
                'locator_value': "//XCUIElementTypeMenuItem[@title='Paste']",
                'need_snapshot': 0,
            },
        ),
    )
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.XPATH',
                'locator_value': "//XCUIElementTypeMenuItem[@title='Cut']",
                'need_snapshot': 0,
            },
        ),
    )
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.XPATH',
                'locator_value': "//XCUIElementTypeMenuItem[@title='Copy']",
                'need_snapshot': 0,
            },
        ),
    )
