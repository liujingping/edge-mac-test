...
# --- auto-generated step ---
@step('I click "Get extensions for Microsoft Edge" button in "Find new extensions"')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
            ...
            arguments={
                ...
                'locator_value': 'Get extensions for Microsoft Edge',
                'need_snapshot': 0,
            },
        ),
    )
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.NAME',
                'locator_value': 'Microsoft Edge Add-ons',
                'need_snapshot': 0,
            },
        ),
    )
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.NAME',
                'locator_value': 'Search extensions, themes, and more',
                'need_snapshot': 0,
            },
        ),
    )
...
# --- auto-generated step ---
@step('I input "icloud" into search box')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
...
# --- auto-generated step ---
@step('I click on "iCloud Passwords" extension in search results')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.NAME',
                'locator_value': 'iCloud Passwords',
                'need_snapshot': 0,
            },
        ),
    )
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.NAME',
                'locator_value': 'iCloud Passwords - Microsoft Edge Addons',
                'need_snapshot': 0,
            },
        ),
    )
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                ...
                'locator_value': '//XCUIElementTypeSheet[@title=\'Add "iCloud Passwords" to '
                "Microsoft Edge?']",
                'need_snapshot': 0,
            },
        ),
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.NAME',
                'locator_value': 'Add "iCloud Passwords" to Microsoft Edge?',
                'need_snapshot': 0,
            },
        ),
    )
...
# --- auto-generated step ---
@step('the "iCloud passwords is now installed." dialog should be shown')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.NAME',
                'locator_value': 'iCloud Passwords is now installed.',
                'need_snapshot': 0,
            },
        ),
    )
