...
# --- auto-generated step ---
@step('I click on "More actions" button in address bar')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
...
# --- auto-generated step ---
@step('I can see playing audio icon in the tab')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.ACCESSIBILITY_ID',
                'locator_value': 'Continue to Read Aloud (⇧⌘U)',
                'need_snapshot': 0,
            },
        ),
    )
...
# --- auto-generated step ---
@step('Playing audio icon in the tab should disappear')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                ...
                'locator_value': '//XCUIElementTypeButton[@label="Close Read Aloud"]',
                'need_snapshot': 0,
            },
        ),
    )
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.XPATH',
                'locator_value': '//XCUIElementTypeTab[contains(@label, "Wikipedia")]',
                'need_snapshot': 0,
            },
        ),
    )
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.ACCESSIBILITY_ID',
                'locator_value': 'Close Read Aloud',
                'need_snapshot': 0,
            },
        ),
    )
