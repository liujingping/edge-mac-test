...
# --- auto-generated step ---
@step('the address bar should display the complete URL "https://www.google.com"')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_value': "//XCUIElementTypeTextField[@label='Address and search bar' and @value='https://www.google.com']",
                'locator_strategy': 'AppiumBy.XPATH',
                'need_snapshot': 0,
            },
        ),
...
# --- auto-generated step ---
@step('I type "https://www.apple.com" in the address bar')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
...
# --- auto-generated step ---
@step('the address bar should display the complete URL "https://www.apple.com"')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_value': "//XCUIElementTypeTextField[@label='Address and search bar' and @value='https://www.apple.com']",
                'locator_strategy': 'AppiumBy.XPATH',
                'need_snapshot': 0,
            },
        ),
...
# --- auto-generated step ---
@step('I press the "Backspace" key')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
...
# --- auto-generated step ---
@step('I input "www.expedia.com" in address bar')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
...
# --- auto-generated step ---
@step('the address bar should display the complete URL "https://www.expedia.com"')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
            ...
            arguments={
                ...
                'caller': 'behave-automation',
                'expected_value': 'https://www.expedia.com',
                'locator_strategy': 'AppiumBy.ACCESSIBILITY_ID',
                'locator_value': 'Address and search bar',
                'need_snapshot': 0,
                'rule': '==',
...
# --- auto-generated step ---
@step('I select all in address bar')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
...
# --- auto-generated step ---
@step('I press "cmd+C" to copy the selected text')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
...
# --- auto-generated step ---
@step('I press "cmd+V" to paste the copied text')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
...
# --- auto-generated step ---
@step('I press "cmd+X" to cut the selected text')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
...
# --- auto-generated step ---
@step('I press "cmd+V" to paste the cut text')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
    ...
    result = call_tool_sync(
        ...
        context.session.call_tool(
            ...
            arguments={
                'caller': 'behave-automation',
                'locator_strategy': 'AppiumBy.XPATH',
                'locator_value': '//XCUIElementTypeStaticText[@value="www.apple.com" and '
                '@selected="true"]',
                'need_snapshot': 0,
            },
        ),
...
# --- auto-generated step ---
@step('I press "delete" to delete the selected text')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
...
# --- auto-generated step ---
@step('I click the "Redo" button in the context menu')
def step_impl(context):
    result = call_tool_sync(
        context,
        context.session.call_tool(
